...
class ProductResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'note' => $this->note,
            'status_logs' => StatusProductLogResource::collection(StatusProductLog::query()->where('product_id', $this->id)->get()),
            'location_logs' => LocationProductLogResource::collection(LocationProductLog::query()->where('product_id', $this->id)->get()),
