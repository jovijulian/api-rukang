                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="content-cell">
                                        ...
                                        <p>Akun Anda telah dibuat. Silahkan verifikasi akun Anda dengan klik link
                                            berikut
                                            link</p>
                                        <p>
                                            <a href="{{ route('verification-success', ['id' => $user->getKey(), 'hash' => sha1(substr($user->id, 4, 6) . $user->email)]) }}"
                                        ...
                                        <p>
                                            <a href="{{ route('verification-success', ['id' => $user->getKey(), 'hash' => sha1(substr($user->id, 4, 6) . $user->email)]) }}"
                                                target="_blank">{{ route('verification-success', ['id' => $user->getKey(), 'hash' => sha1(substr($user->id, 4, 6) . $user->email)]) }}</a>
                                        </p>
                                    </td>
                                </tr>
                            </table>
