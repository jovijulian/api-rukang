...
@section('content')
  <div class="content">
    <div class="page-header">
      ...
      <div class="page-btn">
        <a href="/category/insert" class="btn btn-added remove-role"><img src="{{ url('assets/img/icons/plus.svg') }}" alt="img" class="me-1">Tambah Kategori Baru</a>
      </div>
    </div>
    ...
    $(document).ready(function() {
      ...
      function getData() {
        table.DataTable({
          ...
          ajax: {
            url: "{{ url('api/v1/category/datatable') }}",
            dataType: 'json',
            type: 'POST',
            headers: {
              'X-CSRF-TOKEN': token,
            ...
            {data: 'updated_by'},
            {
              ...
              render: function(data) {
                if (currentUser.isAdmin == 1 || currentUser.isAdmin == 2) {
                  ...
                  return `
                    <a class="me-3" href="/category/edit/` + data + `" ${hiddenRole && 'hidden'}>
                      <img src="assets/img/icons/edit.svg" alt="img" >
                    </a>
                  `
                }
