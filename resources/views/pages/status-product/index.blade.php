...
@section('content')
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-btn">
                <a href="/status-product/insert" class="btn btn-added remove-role"><img
                        src="{{ url('assets/img/icons/plus.svg') }}" alt="img" class="me-1">Tambah Status Produk
                    Baru</a>
            </div>
        </div>
              ...
              <a class="btn btn-filter" id="filter_search">
                ...
                <span><img src="{{ url('assets/img/icons/closes.svg') }}" alt="img"></span>
                    ...
                    <div class="wordset">
                        <ul>
                            <li>
                                <a href="{{ url('api/v1/status-product/report-status-product') }}" data-bs-toggle="tooltip"
