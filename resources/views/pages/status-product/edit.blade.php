...
@section('title')
  <title>Ubah Status Produk</title>
@endsection
  ...
  <div class="cardhead">
    <div class="content container-fluid">
      ...
      <div class="page-header">
        <div class="row">
          <div class="col">
            <h3 class="page-title">Ubah Data Status Produk</h3>
            <ul class="breadcrumb">
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#update-status-form').on('submit', () => {
        ...
        axios.put("{{ url('api/v1/status-product/update/' . $id) }}", data, config)
          .then(res => {
          ...
          .catch(err => {
            ...
            Swal.fire({
              icon: 'error',
              title: 'Status produk gagal diubah',
              text: errorMessage
            })
          })
      ...
      function getData() {
        axios.get("{{ url('api/v1/status-product/detail/' . $id) }}", config)
          .then(res => {
