            ...
            <div class="card-body">
                            ...
                            <div class="col-lg-12 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-1 col-sm-6 col-12">
                                        <div class="form-group">
                                            <a id="delete-filter-data" class="btn btn-filters bg-danger w-100"><img
                                                    src="{{ asset('assets/img/icons/closes.svg') }}" alt="img"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="table-responsive pb-4">
                    <table id="product-table" class="table">
                        <thead>
                            <tr>
                                <th class="text-center p-2"><input type="checkbox" id="select-all"
                            ...
                            <div class="modal-body">
                                <form id="status-form-prev">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="date" id="status-date-prev"
                                                class="form-control text-sm date-now" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input class="form-control mb-1" type="file" id="image-status-prev"
                            ...
                            <div class="modal-body">
                                <form id="status-form-drop">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Tanggal Status *</label>
                                        <div class="col-lg-9">
                                            <input type="date" id="status-date-drop"
                                                class="form-control text-sm date-now" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Upload Foto Status (Maks 10 Foto)</label>
                                        <div class="col-lg-9">
                                            <input class="form-control mb-1" type="file" id="image-status-drop"
                                                accept="image/*" multiple>
                            ...
                            <div class="modal-body">
                                <form id="status-form-next">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Tanggal Status *</label>
                                        <div class="col-lg-9">
                                            <input type="date" id="status-date" class="form-control text-sm date-now"
                                                required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div id="upload-signature-input" class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input class="form-control mb-1" type="file" id="upload-signature"
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Upload Foto Status (Maks 10 Foto)</label>
                                        <div class="col-lg-9">
                                            <input class="form-control mb-1" type="file" id="image-status"
                                                accept="image/*" multiple>
                ...
                <div class="modal fade" id="statusNextModalTravel" tabindex="-1"
                    aria-labelledby="statusNextModalTravelLabel" aria-hidden="true">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 pe-lg-4">
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label">Status Terkini</label>
                                                <div class="col-lg-9">
                                                    <input type="text" class="form-control text-sm recent-status"
                                                        disabled>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label">Tanggal Status *</label>
                                                <div class="col-lg-9">
                                                    <input type="date" id="status-date-travel"
                                                        class="form-control text-sm date-now" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label">Lokasi Terkini</label>
                                                <div class="col-lg-9">
                                                    <input type="text" id="current-location-travel"
                                                        class="form-control" placeholder="Masukan lokasi terkini">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input class="form-control mb-1" type="file"
                                                        id="image-status-travel" accept="image/*" multiple>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 pe-lg-4">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" id="checked-by-gudang"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" id="checked-by-keamanan"
                                                        class="form-control text-sm"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" id="checked-by-produksi"
                                                        class="form-control text-sm"
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label">Diperiksa Oleh (Project
                                                    Manager)</label>
                                                <div class="col-lg-9">
                                                    <input type="text" id="checked-by-project-manager"
                                                        class="form-control text-sm"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" id="received-by-site-manager"
                                                        class="form-control text-sm"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            if ("{{ $statusId }}" == 16) {
                ...
                statusNextId = 22
                $('.next-status').val('08. Disimpan')
            } else if ("{{ $statusId }}" == 22) {
                statusNextId = 23
                $('.next-status').val('09. Perakitan')
            } else if ("{{ $statusId }}" == 23) {
                statusNextId = 24
                $('.next-status').val('10. Perbaikan')
            } else if ("{{ $statusId }}" == 24) {
                statusNextId = 25
                $('.next-status').val('11. Material On-Site')
            } else if ("{{ $statusId }}" == 25) {
                statusNextId = 26
                $('.next-status').val('12. Pemasangan (Erection)')
            } else if ("{{ $statusId }}" == 26) {
                statusNextId = 27
                $('.next-status').val('13. Disetujui PP')
            }
            ...
            if ("{{ $statusId }}" == 27) {
                statusPrevId = 26
                $('.prev-status').val('12. Pemasangan (Erection)')
            } else if ("{{ $statusId }}" == 26) {
                statusPrevId = 25
                $('.prev-status').val('11. Material On-Site')
            } else if ("{{ $statusId }}" == 25) {
                statusPrevId = 24
                $('.prev-status').val('10. Perbaikan')
            } else if ("{{ $statusId }}" == 24) {
                statusPrevId = 23
                $('.prev-status').val('09. Perakitan')
            } else if ("{{ $statusId }}" == 23) {
                statusPrevId = 22
                $('.prev-status').val('08. Disimpan')
            } else if ("{{ $statusId }}" == 22) {
                statusPrevId = 21
                $('.prev-status').val('07. Diterima')
            } else if ("{{ $statusId }}" == 21) {
                statusPrevId = 20
