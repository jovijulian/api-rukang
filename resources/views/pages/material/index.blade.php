...
@section('content')
  <div class="content">
    <div class="page-header">
      ...
      <div class="page-btn">
        <a href="/material/insert" class="btn btn-added"><img src="assets/img/icons/plus.svg" alt="img" class="me-1">Tambah bahan baru</a>
      </div>
    </div>
            ...
            },
            {
              ...
              render: function(data) {
                return `
                  ...
                  <a class="me-5" href="/material/edit/` + data + `">
