  ...
  <div class="cardhead">
    <div class="content container-fluid">
      ...
      <div class="page-header">
        <div class="row">
          <div class="col">
            <h3 class="page-title">Tambah Data Bahan</h3>
            <ul class="breadcrumb">
  ...
  <script>
    $(document).ready(function() {
      ...
      function getCategory() {
        axios.get("{{ url('api/v1/category/index?search=Bahan') }}", config)
          .then(res => {
      ...
      function insertData() {
        ...
        axios.post("{{ url('api/v1/material/create') }}", data, config)
          .then(res => {
            ...
            sessionStorage.setItem("success", `Bahan berhasil ditambahkan`)
