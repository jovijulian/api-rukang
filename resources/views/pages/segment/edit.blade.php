            ...
            <div class="card-body p-4">
              <form id="insert-segment-form">
                <div class="form-group row">
                  ...
                  <div class="col-lg-10">
                    <input type="text" id="segment-name" class="form-control" required>
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-lg-2 col-form-label">Tempat</label>
                  <div class="col-lg-10">
                    <input type="text" id="segment-place" class="form-control" required>
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-lg-2 col-form-label">Warna Barcode</label>
                  <div class="col-lg-10">
                    <input type="text" id="barcode-color" class="form-control">
                  </div>
                </div>
                <div class="text-end">
